...
console.log('task 1 b:' , createMenuItem('pancakes', 8, 'Breakfast' ));
console.log('task 1 b:' , createMenuItem( 'cake', 2, 'Dinner'));
...
function addReview(array, nameValue, ratingValue, feedbackValue){
const newObj ={
  name: nameValue,
  rating: ratingValue,
